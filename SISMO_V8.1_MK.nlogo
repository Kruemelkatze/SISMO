...
undirected-link-breed [network-links network-link]  ; Undirected links
...
to setup
 ...
 ;; py:run "print('hi iam python')"


  py:run "from lean_code_mp import process_intersections"
  ;;random-seed 4711
  ;;random-seed 31012
  random-seed Seed
  print Seed
  ...
  ;;make-foods 12.3 -2.5 ;;Grafenstein
  ;;make-foods 9.1 0.47 ;; St.Veit a. der Glan
  ;;make-foods 6 -0.2 ;; St.Martin Sittich
  ;;make-foods -0.5 -3.99;;Villach
  ;;make-foods -2.9 -2.5;; GUmmern
  ;;make-foods 3.7 -6.7 ;; Rosenbach
  ;;make-foods 8.3 -3.3 ;; Klagenfurt Main Station
  ;;make-foods 8.3 -3.3 ;; Klagenfurt Main Station
 ...
 ;; print date-and-time
  ...
  ;;import-drawing "ktn_umriss_sw.jpeg"
;;import-drawing "ktn_umriss_sw.jpeg"
end


to read-image-and-import-drawing
  ; Ask the user for the image file path or provide the file path directly
  let image-file user-file
  ; Check if the file exists
  if file-exists? image-file [
    ; Import the PNG image as a drawing
...
to go
  print word "Start go:" date-and-time
